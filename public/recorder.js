...
class CounselRecorder {
  constructor() {
    ...
    this.companyUrlEl   = document.getElementById('companyUrl');
  ...
  async toggle() {
    if (this.isRecording) {
      ...
      if (!this.companyNameEl.value.trim()) {
        this.errorDialog.showModal();
        document.getElementById('errorDialogClose').focus();
        return;
      }
